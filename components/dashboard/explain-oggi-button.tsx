...
export function ExplainOggiButton({
  ...
  const label = hasComment ? "💬 Rigenera il commento" : "💬 Spiega la mia giornata";
  ...
  async function handleClick() {
    ...
    setError(null);
    try {
      const response = await fetch("/api/dashboard/explain-oggi", { method: "POST" });
